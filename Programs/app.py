...
app = Flask(__name__)
app.config["UPLOAD_FOLDER"] = "/Volumes/SSD 980 PRO/Vehicle-Detection-Classification-and-Counting/Programs/uploads/"  # Folder to store uploaded videos
app.config["ALLOWED_EXTENSIONS"] = {"mp4", "avi"}  # Allowed video formats
...
def process_video(filename):
    ...
    fgbg = cv2.createBackgroundSubtractorMOG2(
        detectShadows=False, history=200, varThreshold=90
    )
    ...
    while cap.isOpened():
        ...
        if ret == True:
            ...
            frame = cv2.line(
                frame, (0, line_up), (900, line_up), (255, 0, 255), 3, 8
            )  # Magenta
            frame = cv2.line(
                frame, (0, up_limit), (900, up_limit), (0, 255, 255), 3, 8
            )  # Cyan
            frame = cv2.line(
                frame, (0, down_limit), (900, down_limit), (255, 0, 0), 3, 8
            )  # Yellow
            frame = cv2.line(
                frame, (0, line_down), (900, line_down), (255, 0, 0), 3, 8
            )  # Blue

            # To display the Texts
            cv2.putText(frame, str_up, (10, 40), font, 0.5, (0, 0, 255), 2, cv2.LINE_AA)
            cv2.putText(
                frame, str_down, (10, 90), font, 0.5, (255, 0, 0), 2, cv2.LINE_AA
            )
